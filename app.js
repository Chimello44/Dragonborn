  ...
  Az.countDocuments({
    ...
    if (foundAz) {
      ...
      if (az === site) {
        ...
        res.render("fail.ejs", {
          fail: "Cross-connects must be edited within the same AZ",
          route: "/update"
        });
      }
